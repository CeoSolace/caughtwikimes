// server.js – RTM + LM + Replying | <0.3MB RAM | 30min TTL
...
server.listen(process.env.PORT || 3000, '0.0.0.0', () => {
  console.log('VoidChat: Replying + RTM + LM | Live');
});
